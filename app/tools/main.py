...
from app.tools.pairwise_alignment import endpoint as pairwise_alignment_router
from app.tools.phylogenetic_trees import endpoint as phylogenetic_trees_router
from app.tools.variant_calling import endpoint as variant_calling_router
router = APIRouter(
    prefix="/tools",
