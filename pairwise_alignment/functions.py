...
def dataframe(sequence1, sequence2):
    try:
        return dict([
            ...
            ('Total', [
                (sequence1.upper().count('A') + sequence1.upper().count('G') +
                 sequence1.upper().count('C') + sequence1.upper().count('T')),
                (sequence2.upper().count('A') + sequence2.upper().count('G') +
                 sequence2.upper().count('C') + sequence2.upper().count('T'))
            ])
        ])
